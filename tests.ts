...
openLog.writeRowWithTextToCSV(["x", "123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ", "y"], HeaderLine.YES)
openLog.writeRowWithNumbersToCSV([7, 1.1111111111111111e+144, 7], HeaderLine.NO)
